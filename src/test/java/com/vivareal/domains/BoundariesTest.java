...
public class BoundariesTest {
    ...
    public void test_findContainedProperties() {
        ...
        final Property inside1 = createPropertie("37363019-4db7-42c1-88fc-678c58cb1544", 2,2);
        final Property inside2 = createPropertie("4e56f650-4196-4438-85d6-8173380bb6db", 5,10);
        final Property outside1 = createPropertie("aad5fa08-f0a1-4a6e-8abc-5abff2a45e96", 11, 1);
        final Property outside2 = createPropertie("47107ea5-ad05-498a-8056-5011b19c3cf4", 4, 0);
        final Collection<Property> properties = Arrays.asList(inside1, inside2, outside1, outside2);

        final Collection<Property> result = boundaries.findContainedProperties(properties);
    ...
    private Property createPropertie(final String id, final Integer x, final Integer y) {
